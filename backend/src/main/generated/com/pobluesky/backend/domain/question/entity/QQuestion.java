...
public class QQuestion extends EntityPathBase<Question> {
    ...
    public final com.pobluesky.backend.domain.answer.entity.QAnswer answer;
    ...
    public QQuestion(Class<? extends Question> type, PathMetadata metadata, PathInits inits) {
        ...
        this.answer = inits.isInitialized("answer") ? new com.pobluesky.backend.domain.answer.entity.QAnswer(forProperty("answer"), inits.get("answer")) : null;
