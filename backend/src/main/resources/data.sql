...
-- 2023년
-- 1월
    (1, 1, null, 'USA', 'HYCON', 'Hyundai Construction', 'COMMON_INQUIRY', 'AUTOMOBILE', '(주)포스코', 'CAR', 'SUBMIT', '2023-01-19', '빠르게 처리 부탁드립니다.', 'file1.pdf', 'file1Name', null, true, true, '2023-01-05 09:15:22.123456+00', '2023-01-05 09:15:22.123456+00'),
    (2, 2, 1, 'CANADA', 'SAMC', 'Samsung C&T', 'COMMON_INQUIRY', 'CONSTRUCTION', '(주)포스코', 'HOT_ROLLED', 'FINAL_REVIEW_COMPLETED', '2023-01-24', '문서 확인 부탁드립니다.', 'file2.pdf', 'file2Name', null, true, false, '2023-01-10 10:30:15.987654+00', '2023-01-10 10:30:15.987654+00'),
    (3, 3, null, 'KOREA', 'GS', 'GS E&C', 'QUOTE_INQUIRY', 'ELECTRIC', '(주)포스코', 'COLD_ROLLED', 'RECEIPT', '2023-01-29', '빠른 검토 부탁드립니다.', 'file3.pdf', 'file3Name', null, true, true, '2023-01-15 11:45:30.654321+00', '2023-01-15 11:45:30.654321+00'),
    (4, 4, 2, 'JAPAN', 'DLENC', 'DL E&C', 'COMMON_INQUIRY', 'DISTRIBUTION', '(주)포스코', 'THICK_PLATE', 'QUALITY_REVIEW_RESPONSE', '2023-01-31', '검토 후 회신 부탁드립니다.', 'file4.pdf', 'file4Name', null, true, false, '2023-01-20 09:15:22.123456+00', '2023-01-20 09:15:22.123456+00'),
    (5, 5, null, 'CHINA', 'HDC', 'HDC Hyundai', 'QUOTE_INQUIRY', 'FURNITURE', '(주)포스코', 'WIRE_ROD', 'FIRST_REVIEW_COMPLETED', '2023-01-31', '추가 요청 사항 포함.', 'file5.pdf', 'file5Name', null, true, true, '2023-01-25 12:30:45.123456+00', '2023-01-25 12:30:45.123456+00'),
    (6, 6, null, 'GERMANY', 'PCO', 'POSCO E&C', 'COMMON_INQUIRY', 'HIGH_CARBON', '(주)포스코', 'CAR', 'SUBMIT', '2023-01-24', '확인 부탁드립니다.', 'file6.pdf', 'file6Name', null, true, false, '2023-01-10 14:00:05.654321+00', '2023-01-10 14:00:05.654321+00'),
    (7, 7, null, 'FRANCE', 'SAMC', 'Samsung C&T', 'QUOTE_INQUIRY', 'KITCHEN', '(주)포스코', 'HOT_ROLLED', 'RECEIPT', '2023-01-29', '검토 완료 후 전달 부탁드립니다.', 'file7.pdf', 'file7Name', null, true, true, '2023-01-15 09:15:22.123456+00', '2023-01-15 09:15:22.123456+00'),
    (8, 8, 3, 'KOREA', 'HS', 'HYOSUNG', 'COMMON_INQUIRY', 'LOW_CARBON', '(주)포스코', 'COLD_ROLLED', 'QUALITY_REVIEW_COMPLETED', '2023-01-31', '문서 재확인 부탁드립니다.', 'file8.pdf', 'file8Name', null, true, false, '2023-01-20 16:45:10.987654+00', '2023-01-20 16:45:10.987654+00'),
    (9, 9, 4, 'USA', 'DLENC', 'DL E&C', 'COMMON_INQUIRY', 'MACHINERY', '(주)포스코', 'THICK_PLATE', 'FINAL_REVIEW_COMPLETED', '2023-01-20', '검토 후 최종 회신 부탁드립니다.', 'file9.pdf', 'file9Name', null, true, true, '2023-01-01 09:15:22.123456+00', '2023-01-01 09:15:22.123456+00'),
    (10, 10, 5, 'CANADA', 'HDC', 'HDC Hyundai', 'COMMON_INQUIRY', 'PIPE', '(주)포스코', 'WIRE_ROD', 'QUALITY_REVIEW_REQUEST', '2023-01-19', '확인 부탁드립니다.', 'file10.pdf', 'file10Name', null, true, false, '2023-01-05 10:00:30.123456+00', '2023-01-05 10:00:30.123456+00'),

-- 2월
    (11, 11, null, 'USA', 'KCCON', 'KCC Construction', 'COMMON_INQUIRY', 'REROLLING', '(주)포스코', 'CAR', 'SUBMIT', '2023-02-05', '빠르게 처리 부탁드립니다.', 'file1.pdf', 'file1Name', null, true, true, '2023-02-05 09:15:22.123456+00', '2023-02-05 09:15:22.123456+00'),
    (12, 12, 6, 'CANADA', 'BYGROUP', 'Booyoung Group', 'COMMON_INQUIRY', 'SHIPBUILDING', '(주)포스코', 'HOT_ROLLED', 'FINAL_REVIEW_COMPLETED', '2023-02-10', '문서 확인 부탁드립니다.', 'file2.pdf', 'file2Name', null, true, false, '2023-02-10 10:30:15.987654+00', '2023-02-10 10:30:15.987654+00'),
    (13, 13, null, 'KOREA', 'EGCON', 'EG Construction', 'QUOTE_INQUIRY', 'TRANSPORTATION', '(주)포스코', 'COLD_ROLLED', 'RECEIPT', '2023-02-15', '빠른 검토 부탁드립니다.', 'file3.pdf', 'file3Name', null, true, true, '2023-02-15 11:45:30.654321+00', '2023-02-15 11:45:30.654321+00'),
    (14, 14, 7, 'JAPAN', 'HOBAN', 'Hoban Construction', 'COMMON_INQUIRY', 'VESSEL', '(주)포스코', 'THICK_PLATE', 'QUALITY_REVIEW_RESPONSE', '2023-02-20', '검토 후 회신 부탁드립니다.', 'file4.pdf', 'file4Name', null, true, false, '2023-02-20 09:15:22.123456+00', '2023-02-20 09:15:22.123456+00'),
    (15, 15, null, 'CHINA', 'JEICON', 'Jeil Construction', 'QUOTE_INQUIRY', 'BEAM', '(주)포스코', 'WIRE_ROD', 'FIRST_REVIEW_COMPLETED', '2023-02-25', '추가 요청 사항 포함.', 'file5.pdf', 'file5Name', null, true, true, '2023-02-25 12:30:45.123456+00', '2023-02-25 12:30:45.123456+00'),
    (16, 16, null, 'GERMANY', 'CITYCON', 'City Construction', 'COMMON_INQUIRY', 'AUTOMOBILE', '(주)포스코', 'CAR', 'SUBMIT', '2023-02-10', '확인 부탁드립니다.', 'file6.pdf', 'file6Name', null, true, false, '2023-02-10 14:00:05.654321+00', '2023-02-10 14:00:05.654321+00'),
    (17, 17, null, 'FRANCE', 'FIELDTECH', 'Field Tech', 'QUOTE_INQUIRY', 'CONSTRUCTION', '(주)포스코', 'HOT_ROLLED', 'RECEIPT', '2023-02-15', '검토 완료 후 전달 부탁드립니다.', 'file7.pdf', 'file7Name', null, true, true, '2023-02-15 09:15:22.123456+00', '2023-02-15 09:15:22.123456+00'),
    (18, 18, 8, 'KOREA', 'JINHYUN', 'Jinhyun Construction', 'COMMON_INQUIRY', 'PIPE', '(주)포스코', 'COLD_ROLLED', 'QUALITY_REVIEW_COMPLETED', '2023-02-20', '문서 재확인 부탁드립니다.', 'file8.pdf', 'file8Name', null, true, false, '2023-02-20 16:45:10.987654+00', '2023-02-20 16:45:10.987654+00'),
    (19, 19, 9, 'USA', 'HANKOOK', 'Hankook Tire', 'COMMON_INQUIRY', 'RAIL', '(주)포스코', 'THICK_PLATE', 'FINAL_REVIEW_COMPLETED', '2023-02-01', '검토 후 최종 회신 부탁드립니다.', 'file9.pdf', 'file9Name', null, true, true, '2023-02-01 09:15:22.123456+00', '2023-02-01 09:15:22.123456+00'),
    (20, 20, 10, 'CANADA', 'LOTTE', 'Lotte Group', 'COMMON_INQUIRY', 'FURNITURE', '(주)포스코', 'WIRE_ROD', 'QUALITY_REVIEW_REQUEST', '2023-02-05', '확인 부탁드립니다.', 'file10.pdf', 'file10Name', null, true, false, '2023-02-05 10:00:30.123456+00', '2023-02-05 10:00:30.123456+00');
