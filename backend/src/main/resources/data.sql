...
VALUES
    ...
    (3, 'GERMANY', '123 Industries', 'Charlie Boss', 'COMMON_INQUIRY', 'ELECTRIC', 'CORP003', 'COLD_ROLLED', 'QUALITY_REVIEW', '2023-08-03', 'Follow-up needed', 'Bob Supervisor', 'HR', 'Bob Supervisor', 'file3.pdf', '2023-08-20', '7', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (4, 'KOREA', 'Mr.Son', 'Charlie Boss', 'COMMON_INQUIRY', 'ELECTRIC', 'CORP005', 'CAR', 'QUALITY_REVIEW', '2023-08-04', 'Follow-up needed', 'Bob Supervisor', 'HR', 'Bob Supervisor', 'file4.pdf', '2023-08-21', '9', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-05', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file1.pdf', '2023-08-12', '5', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-06', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file2.pdf', '2023-08-13', '6', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-07', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file3.pdf', '2023-08-14', '7', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-08', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file4.pdf', '2023-08-15', '8', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-09', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file5.pdf', '2023-08-16', '9', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-10', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file6.pdf', '2023-08-17', '10', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-11', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file7.pdf', '2023-08-18', '11', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-12', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file8.pdf', '2023-08-19', '12', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-13', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file9.pdf', '2023-08-20', '13', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-14', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file10.pdf', '2023-08-21', '14', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-15', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file11.pdf', '2023-08-22', '15', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-16', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file12.pdf', '2023-08-23', '16', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-17', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file13.pdf', '2023-08-24', '17', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-18', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file14.pdf', '2023-08-25', '18', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-19', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file15.pdf', '2023-08-26', '19', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-20', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file16.pdf', '2023-08-27', '20', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-21', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file17.pdf', '2023-08-28', '21', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-22', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file18.pdf', '2023-08-29', '22', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'USA', 'ABC Corp', 'Alice Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-23', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file19.pdf', '2023-08-30', '23', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 'GERMANY', 'ABC Corp', 'Jihyeon Manager', 'QUOTE_INQUIRY', 'AUTOMOBILE', 'CORP001', 'CAR', 'RECEIPT', '2023-08-24', 'Urgent request', 'Bob Supervisor', 'SALES', 'Charlie Boss', 'file20.pdf', '2023-08-31', '24', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
