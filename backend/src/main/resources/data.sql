...
VALUES
    ('2024-08-01 10:00:00', null, 1, '귀사의 고객 서비스 문의 소요 기간에 대한 자세한 정보 요청', '귀사의 서비스를 이용함에 있어, 문의 사항이 발생할 경우 평균적으로 처리되는 소요 기간이 궁금하여 이렇게 메일을 드립니다. 귀사에서 문의에 대한 답변을 제공해주시는 데 걸리는 평균적인 시간을 알려주시면 감사하겠습니다.', 'voc_report1.pdf', 'https://cdn.imweb.me/upload/S201910012ff964777e0e3/62f9a36ea3cea.jpg', 'ETC', 'COMPLETED', true),
    ...
    ('2024-08-05 10:00:00', null, 2, '회원 가입 과정에서 발생하는 지속적인 오류 문제 해결 요청', '귀사 웹사이트에서 회원 가입을 진행하던 중, 문제가 발생하여 가입을 완료할 수 없었습니다. 구체적으로, 가입 양식을 제출할 때 오류 메시지가 표시되는 문제가 발생했습니다. 이 문제를 해결하기 위해 어떻게 해야 하는지 안내해 주시면 감사하겠습니다.', 'voc_report7.pdf', 'https://cdn.example.com/image2.jpg', 'SITE', 'COMPLETED', true),
    ('2024-08-06 11:00:00', 2, 2, '결제 과정에서 발생하는 지속적인 오류 문제 해결 요청', '귀사 웹사이트에서 결제를 진행하던 중, 오류가 발생하여 결제가 완료되지 않았습니다. 결제 정보 입력 후 결제 실패 메시지가 표시되었습니다. 이 문제를 해결하기 위한 방법을 안내해 주시면 감사하겠습니다.', 'voc_report8.pdf', 'https://cdn.example.com/image3.jpg', 'INQ', 'READY', true),
    ...
    ('2024-08-08 13:00:00', null, 5, '최첨단 기술 지원 요청: "오류 503: 서비스 이용 불가" 문제', '프로그램 실행 중 "오류 503: 서비스 이용 불가"라는 메시지가 나타나며, 이후 소프트웨어가 강제 종료됩니다. 이로 인해 작업이 중단되고 있습니다.', 'voc_report10.pdf', 'https://cdn.example.com/image5.jpg', 'ETC', 'READY', true),
    ('2024-08-09 14:00:00', 5, 5, '선재 제품의 결함으로 인한 환불 요청', '최근에 귀사에서 제품을 구매하였으나, 제품에 결함이 있고 기대했던 성능과 다르다는 이유로 환불을 요청드립니다.', 'voc_report11.pdf', 'https://cdn.example.com/image6.jpg', 'INQ', 'COMPLETED', true),
    ...
    ('2024-08-11 16:00:00', null, 3, '서비스 품질 향상을 위한 개선 요청 및 피드백 제출', '이와 같은 문제를 개선하여 서비스 품질을 향상시키는 데 도움이 되기를 바랍니다. 제 피드백이 귀사에 유익하게 사용되기를 바라며, 추가적인 정보나 논의가 필요하시면 언제든지 연락 주시기 바랍니다.', 'voc_report13.pdf', 'https://cdn.example.com/image8.jpg', 'ETC', 'COMPLETED', true),
    ('2024-08-12 17:00:00', 8, 3, '후판 제품 배송 주소 변경 요청', '변경된 주소로 배송이 이루어질 수 있도록 조치해 주시면 감사하겠습니다. 주소 변경이 가능한지, 그리고 추가로 필요한 절차가 있는지 안내해 주시면 좋겠습니다.', 'voc_report14.pdf', 'https://cdn.example.com/image9.jpg', 'INQ', 'READY', true),
    ...
    ('2024-08-20 15:00:00', 13, 3, '프로그램 실행 중 "오류 503 서비스 이용 불가" 메시지 발생 문제 해결 요청', '프로그램 실행 중 "오류 503: 서비스 이용 불가"라는 메시지가 나타나며, 이후 소프트웨어가 강제 종료됩니다. 이로 인해 작업이 중단되고 있습니다.', 'voc_report22.pdf', 'https://cdn.example.com/image17.jpg', 'INQ', 'READY', true),
