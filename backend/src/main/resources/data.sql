...
VALUES
    ...
    (2, 'JAPAN', 'BR', 'BORAM', 'QUOTE_INQUIRY', 'CONSTRUCTION', '(주)포스코', 'HOT_ROLLED', 'FIRST_REVIEW', '2023-08-02', '이전 요청을 참고해주세요', 'file2.pdf','file2Name', '2023-08-15', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    (1, 'CANADA', 'CC', 'CANCO', 'QUOTE_INQUIRY', 'SHIPBUILDING', '(주)포스코', 'CAR', 'FINAL_REVIEW', '2023-08-05', '빠른 납품 필요', 'file6.pdf', 'file6Name', '2023-08-22', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    (5, 'GERMANY', 'MG', 'MEGA', 'QUOTE_INQUIRY', 'PIPE', '(주)포스코', 'THICK_PLATE', 'FINAL_REVIEW', '2023-08-09', '안정적인 공급 요청', 'file10.pdf', 'file10Name', '2023-09-05', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    (3, 'JAPAN', 'BR', 'BORAM', 'COMMON_INQUIRY', 'DISTRIBUTION', '(주)포스코', 'WIRE_ROD', 'FIRST_REVIEW', '2023-08-12', '고객의견 반영', 'file13.pdf', 'file13Name', '2023-09-20', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
