...
VALUES
    ('김민준', 'john@example.com', '{bcrypt}$2a$10$QMI8oRrhJe1hht39orh7Ke1aPUoP6jIatXrZxMDi.v5c24yBczPnu', '010-1234-4560', true, '3GPOA', 'POSCO Asia', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('박도윤', 'jane@example.com', '{bcrypt}$2a$10$QMI8oRrhJe1hht39orh7Ke1aPUoP6jIatXrZxMDi.v5c24yBczPnu', '010-9876-3210', true, '2BR', 'BORAM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
    ('박수아', 'alice@company.com', '{bcrypt}$2a$10$QMI8oRrhJe1hht39orh7Ke1aPUoP6jIatXrZxMDi.v5c24yBczPnu', '010-2222-3333', true, 'EMP001', 'SALES', 'SALES', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('이현우', 'bob@company.com', '{bcrypt}$2a$10$QMI8oRrhJe1hht39orh7Ke1aPUoP6jIatXrZxMDi.v5c24yBczPnu', '010-5555-6666', true, 'EMP002', 'QUALITY', 'IT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('김우진', 'charlie@company.com', '{bcrypt}$2a$10$QMI8oRrhJe1hht39orh7Ke1aPUoP6jIatXrZxMDi.v5c24yBczPnu', '010-0888-9999', true, 'EMP003', 'SALES', 'HR', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
