  ...
  return (
      <div>
        <Container style={{ margin: '20vh' }}>
          ...
          <Wrapper>
            <DataBox>
              <Text textAlign={'left'} marginTop={'3vh'} marginLeft={'3vh'}
                    fontSize={'24px'} fontWeight={'800'} color={'#49454F'}
                    lineHeight={'40px'}>
                후판(육상플랜트) 문의 응대 수가<br/>
                <span style={{color: '#0B9DDE'}}>59건 증가했어요</span>
              </Text>
              <DataIcon backgroundColor={'#0B9DDE'}>+146%</DataIcon>
              <Graph lastMonth={'236'} thisMonth={'295'} barColor={'#0B9DDE'}
                     textColor={'#000000'} arrow={increaseArrow}/>
            </DataBox>
            <DataBox>
              <Text textAlign={'left'} marginTop={'3vh'} marginLeft={'3vh'}
                    fontSize={'24px'} fontWeight={'800'} color={'#49454F'}
                    lineHeight={'40px'}>
                제품 1차 검토 응대 시간이<br/>
                <span style={{color: '#20AC70'}}>2시간 감소했어요</span>
              </Text>
              <DataIcon backgroundColor={'#20AC70'}>-146%</DataIcon>
              <Graph lastMonth={'295'} thisMonth={'236'} barColor={'#56E1A5'}
                     textColor={'#000000'} arrow={decreaseArrow}
                     decrease={true}/>
            </DataBox>
          </Wrapper>
