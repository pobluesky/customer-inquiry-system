...
import { Container, Sheet, Opend, QualityItemColumn, _none } from "../../../assets/css/Form.css";
...
const QualityReviewTextForm = () => { // 최종 검토 내용
  ...
  return (
      <div className={Container} style={{ marginTop: '-2vh' }}>
        <div className={Sheet}>
          <ToggleBar title={"품질검토정보"} isChecked={isChecked} setCheck={setCheck} />
          {isChecked ? (
              <div className={Opend}>
                <ReviewText title={"품질검토내용"} width="115px" height="100px" />
