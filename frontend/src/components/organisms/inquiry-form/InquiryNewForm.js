...
const   InquiryNewForm = ({ formData, handleFormDataChange }) => {
    ...
    return (
        <div className={Container}>
            <div className={Sheet}>
                <ToggleBar title={"Inquiry 신규 등록"} isChecked={isChecked}
                           setCheck={setCheck} />
                {isChecked ? (
                    <div className={Opend}>
                        <div className={Wrapper}>
                            ...
                            <div className={inputWrapper}>
                                ...
                                >
                                    ...
                                    <option value="COMMON_INQUIRY">품질 + 견적
                                    </option>
                                    <option value="QUALITY_INQUIRY">품질</option>
                            ...
                            <div className={inputWrapper}>
                                ...
                                >
                                    ...
                                    <option value="HIGH_CARBON">High-Carbon</option>
                                    <option value="KITCHEN">Kitchen</option>
                                    <option value="LOW_CARBON">Low-Carbon</option>
                                    <option value="MARCHINERY">Machinery</option>
                            ...
                            <div className={inputWrapper}>
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleFormDataChange(
                                        'corporationCode', e.target.value)}
                                />
                            </div>
                            <div className={inputWrapper}>
                                <label>제품</label>
                            ...
                            <div className={inputWrapper}>
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleFormDataChange(
                                        'customerRequestDate', e.target.value)}
                                />
                            </div>
                        </div>
                    </div>
