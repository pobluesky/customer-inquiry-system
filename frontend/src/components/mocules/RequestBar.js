...
function RequestBar() {
    return (
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '2vh' }}>
            <div style={{ width: '80vw', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#f0f8fc', border: 'solid #c1c1c1 1px', padding: '1vw', borderRadius: '20px', margin: '1vw' }}>
