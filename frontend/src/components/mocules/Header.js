                ...
                <>
                    ...
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            <Link to="/inq" style={{ marginRight: '6vw', textDecoration: 'none', color: '#03507d', fontSize: '1.5em', fontWeight: 'bold' }}>Inquiry</Link>
                            <Link to="/voc" style={{ marginRight: '6vw', textDecoration: 'none', color: '#03507d', fontSize: '1.5em', fontWeight: 'bold' }}>VoC</Link>
                            <Link to="/dashboard" style={{ marginRight: '6vw', textDecoration: 'none', color: '#03507d', fontSize: '1.5em', fontWeight: 'bold' }}>DashBoard</Link>
