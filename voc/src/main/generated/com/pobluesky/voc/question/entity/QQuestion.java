...
public class QQuestion extends EntityPathBase<Question> {
    ...
    private static final long serialVersionUID = 1148441056L;
    ...
    public final com.pobluesky.voc.answer.entity.QAnswer answer;
    ...
    public QQuestion(Class<? extends Question> type, PathMetadata metadata, PathInits inits) {
        ...
        this.answer = inits.isInitialized("answer") ? new com.pobluesky.voc.answer.entity.QAnswer(forProperty("answer"), inits.get("answer")) : null;
    }
